...
public class ParserUtilTest {
    ...
    @Test
    public void parseResult_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseResult(null));
    }

    @Test
    public void parseResult_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseResult(INVALID_RESULT));
    }

    @Test
    public void parseResult_validValueWithoutWhitespace_returnsResult() throws Exception {
        Result expectedResult = new Result(VALID_RESULT);
        assertEquals(expectedResult, ParserUtil.parseResult(VALID_RESULT));
    }

    @Test
    public void parseResult_validValueWithWhitespace_returnsTrimmedResult() throws Exception {
        String resultWithWhitespace = WHITESPACE + VALID_RESULT + WHITESPACE;
        Result expectedResult = new Result(VALID_RESULT);
        assertEquals(expectedResult, ParserUtil.parseResult(resultWithWhitespace));
    }
}
